...
import { getLinkFromDir, APPZ_DIR, APPZ_DIR_PROJECT } from './link';
...
// Write the project configuration to `.appz/project.json`
...
export async function writeProjectSettings(
  ...
  const path = join(cwd, APPZ_DIR, APPZ_DIR_PROJECT);
